...
declare interface Window {
  ...
  wx: {
     ...
     */
    onMenuShareTimeline(options: OnMenuShareTimelineOptions): void

    /**
     * 获取“分享给朋友”按钮点击状态及自定义分享内容接口
     */
    onMenuShareAppMessage(options: OnMenuShareAppMessageOptions): void

    /**
     * 获取“分享到QQ”按钮点击状态及自定义分享内容接口
     */
    onMenuShareQQ(options: OnMenuShareQQ): void

    /**
     * 获取“分享到腾讯微博”按钮点击状态及自定义分享内容接口
     */
    onMenuShareWeibo(options: OnMenuShareWeibo): void

    /**
     * 获取“分享到QQ空间”按钮点击状态及自定义分享内容接口
     */
    onMenuShareQZone(options: OnMenuShareQZone): void
     ...
     */
    uploadImage(options: UploadImageOptions): void
     ...
     * 获取本地图片接口
     */
    getLocalImgData(options: GetLocalImgDataOptions): void
     ...
     * 停止录音接口
     */
    stopRecord(options: Callbacks): void

    /**
     * 监听录音自动停止接口
     */
    onVoiceRecordEnd(options: Callbacks): void

    /**
     * 播放语音接口
     */
    playVoice(options: LocalVoiceOptions): void

    /**
     * 暂停播放接口
     */
    pauseVoice(options: LocalVoiceOptions): void

    /**
     * 停止播放接口
     */
    stopVoice(options: LocalVoiceOptions): void

    /**
     * 监听语音播放完毕接口
     */
    onVoicePlayEnd(options: Callbacks): void

    /**
     * 上传语音接口
     */
    uploadVoice(options: UploadVoiceOptions): void

    /**
     * 下载语音接口
     */
    downloadVoice(options: DownloadVoiceOptions): void
     ...
     * 识别音频并返回识别结果接口
     */
    translateVoice(options: UploadVoiceOptions): void
     ...
     * 获取网络状态接口
     */
    getNetworkType(options: Callbacks): void
     ...
     * 开启查找周边ibeacon设备接口
     */
    startSearchBeacons(options: StartSearchBeacons): void

    /**
     * 关闭查找周边ibeacon设备接口
     */
    stopSearchBeacons(options: Callbacks): void
     ...
     */
    onSearchBeacons(options: Callbacks): void
     ...
     * 批量隐藏功能按钮接口
     */
    hideMenuItems(options: MenuOptions): void

    /**
     * 批量显示功能按钮接口
     */
    showMenuItems(options: MenuOptions): void
     ...
     * 跳转微信商品页接口
     */
    openProductSpecificView(options: OpenProductSpecificViewOptions): void
     ...
     * 拉取适用卡券列表并获取用户选择信息
     */
    chooseCard(options: ChooseCardOptions): void
     ...
     * 发起一个微信支付请求
     */
    chooseWXPay(options: ChooseWXPayOptions): void
  }
}
